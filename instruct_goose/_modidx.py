...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'instruct_goose.actor': { 'instruct_goose.actor.Actor': ('actor.html#actor', 'instruct_goose/actor.py'),
            ...
            'instruct_goose.agent': { 'instruct_goose.agent.Agent': ('agent.html#agent', 'instruct_goose/agent.py'),
                                      ...
                                      'instruct_goose.agent.Agent.get_idx_from_logits': ( 'agent.html#agent.get_idx_from_logits',
                                                                                          'instruct_goose/agent.py'),
            ...
            'instruct_goose.trainer': { 'instruct_goose.trainer.RLHFTrainer': ('trainer.html#rlhftrainer', 'instruct_goose/trainer.py'),
                                        ...
                                        'instruct_goose.trainer.RLHFTrainer.forward': ( 'trainer.html#rlhftrainer.forward',
                                                                                        'instruct_goose/trainer.py'),
                                        'instruct_goose.trainer.RLHFTrainer.forward_batch': ( 'trainer.html#rlhftrainer.forward_batch',
                                                                                              'instruct_goose/trainer.py'),
                                        'instruct_goose.trainer.RLHFTrainer.loss': ( 'trainer.html#rlhftrainer.loss',
                                                                                     'instruct_goose/trainer.py'),
                                        'instruct_goose.trainer.RLHFTrainer.step': ( 'trainer.html#rlhftrainer.step',
                                                                                     'instruct_goose/trainer.py')},
